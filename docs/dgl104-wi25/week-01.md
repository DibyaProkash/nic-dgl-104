...
### [RECOMMENDED] WRITE A DAILY JOURNAL ENTRY <!-- {docsify-ignore} -->
...
### [REQUIRED] TALK TO ME APP TUTORIALS PARTS 1 - 4 <!-- {docsify-ignore} -->
...
### [REQUIRED] AI2 SPACE INVADERS APP <!-- {docsify-ignore} -->
...
### [RECOMMENDED] FOLLOW-UP QUESTIONS AND REFLECTIONS <!-- {docsify-ignore} -->
...
### INSTALLING ANDROID STUDIO <!-- {docsify-ignore} -->
...
### INSTALLING THE APK ON THE EMULATOR <!-- {docsify-ignore} -->
